...
export default function Home() {
  ...
  }, [currentSentence, currentIndex, typingSpeed])
      ...
      <div className=" md:py-20 md:mt-28 z-[100] px-4 lg:px-8">
        <div className="mx-auto mb-4 md:mb-10 max-w-4xl text-center">
          ...
          <div className="mb-3 md:mb-4 h-16">
            <span className={cn('text-4xl sm:text-6xl text-foreground')}>
              {blackText}
            </span>
            <span
              className={cn(
                'text-4xl sm:text-6xl text-transparent bg-clip-text bg-gradient-to-br from-[#e64c8c]' +
                  ' to-[#645cd8]',
              )}
            >
              {gradientText}
          ...
          <p className="md:text-lg max-w-2xl mx-auto text-center">
            <span className="hidden md:inline">
              Supercharge your productivity with Quanta - the
            </span>
            <span className="md:hidden inline">The</span> groundbreaking
            solution for every kind of AI assist. Unlock the full potential of
            Quanta.
          </p>
        </div>
