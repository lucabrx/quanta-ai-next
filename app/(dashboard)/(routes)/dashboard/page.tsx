    ...
    return (
        <main>
            <div className="mb-8 space-y-2 px-4 md:px-8">
                <h2 className="text-2xl lg:text-3xl font-bold">Explore the power of Quanta</h2>
                <p className="text-muted-foreground font-light text-sm  ">Use our amazing AI for lots of use-cases</p>
            </div>
